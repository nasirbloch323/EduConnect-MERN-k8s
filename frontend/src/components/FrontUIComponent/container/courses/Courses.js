			...
			<div className='container mt-4 mb-4'>
				...
				<div className='row'>
					<div className='p-1 a-card col-md-3 ' data-aos='zoom-in-up'>
						...
						<div className=' '>
							<h5 className='fs-6 p-2 text-black uppercase'>
								UO ARCHAEOLOGY DEPT. DISCOVERED 2000 YEARS OLD UNIQUE EVIDENCES
					...
					<div className='p-1 a-card col-md-3' data-aos='zoom-in-up'>
						...
						<div className=' '>
							<h5 className='fs-6 p-2 text-black uppercase'>
								Uo RESEARCHER FINDS HEAVY METALS TOXICITY IN CHASHMA BARRAGE
								MUSSELS
							</h5>
						</div>
					</div>
