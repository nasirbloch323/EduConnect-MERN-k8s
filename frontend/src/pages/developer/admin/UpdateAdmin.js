    ...
    <>
        ...
        <CardContent className="grid gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input id="update-admin-email" placeholder="Enter email" type="email" />
          </div>
          <div className="flex flex-col gap-2">
            <Label htmlFor="update-admin-password">Password</Label>
            <Input id="update-admin-password" placeholder="Enter password" type="password" />
          </div>
          <div className="flex flex-col gap-2">
            <Label htmlFor="update-admin-department">Department</Label>
            <Input id="update-admin-department" placeholder="Enter department" />
          </div>
          <div className="flex flex-col gap-2">
            <Label htmlFor="update-admin-phone">Phone Number</Label>
            <Input id="update-admin-phone" placeholder="Enter phone number" type="tel" />
          </div>
