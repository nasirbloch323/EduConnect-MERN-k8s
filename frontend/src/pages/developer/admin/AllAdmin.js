                ...
                <Card>
                    ...
                    <CardContent className="flex flex-col gap-4">
                        ...
                        <div className="border rounded-lg">
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow>
                                        <TableCell className="font-medium">Dr. Ghulam Ali</TableCell>
                                    ...
                                    <TableRow>
                                        <TableCell className="font-medium">Prof. Riaz Ul Amin</TableCell>
                                    ...
                                    <TableRow>
                                        <TableCell className="font-medium">Prof. Ahmad Nazir</TableCell>
                    ...
                    <CardFooter>
                        <Link to='/Developer/add-admin'>
                            <Button className="ml-auto">Add new admin</Button></Link>
                    </CardFooter>
                </Card>
            </Container>
        </>
